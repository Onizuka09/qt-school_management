...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_TimeTable_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_TimeTable_t qt_meta_stringdata_TimeTable = {
    {
        QT_MOC_LITERAL(0, 9)   // "TimeTable"
    },
    "TimeTable"
};
...
const QMetaObject TimeTable::staticMetaObject = { {
    ...
    qt_meta_stringdata_TimeTable.offsetsAndSizes,
    qt_meta_data_TimeTable,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_TimeTable_t
